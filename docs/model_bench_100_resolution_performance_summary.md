...
Rows are ranked by audit pass, survival state, higher P&L versus initial bankroll, lower drawdown, then lower forecast cost.
...
|---:|---|---|---|---|---:|---:|---:|---:|---|---:|---:|---:|---:|---:|---:|---|
| 1 | rule_baseline_100/imported | rule_baseline | rule_baseline_midpoint | PASS | 100.00% | 100.00% | 0 | 0.0000 | ALIVE | 50.00 | 50.00 | 0.00 | 100 | 0 | 0 | no_trades;market_echo;no_actionable_edges |
| 2 | next_model_blind_100/imported | agy | Gemini 3.5 Flash High via agy blind | PASS | 100.00% | 0.00% | 53 | 0.0000 | ALIVE | 50.00 | 46.07 | -3.93 | 100 | 9 | 9 | open_positions;loss |
| 3 | next_model_blind_100_exit_edge/imported | agy | Gemini 3.5 Flash High via agy blind exit_edge_0.08 | PASS | 100.00% | 0.00% | 53 | 0.0000 | ALIVE | 50.00 | 46.07 | -3.93 | 100 | 9 | 9 | open_positions;loss |
| 4 | next_model_blind_100_official_resolution_check/imported | agy | Gemini 3.5 Flash High via agy blind official_resolution_check | PASS | 100.00% | 0.00% | 53 | 0.0000 | ALIVE | 50.00 | 46.07 | -3.93 | 100 | 9 | 9 | open_positions;loss |
| 5 | next_model_blind_100_forced_exit/imported | agy | Gemini 3.5 Flash High via agy blind forced_exit | PASS | 100.00% | 0.00% | 53 | 0.0000 | ALIVE | 50.00 | 44.69 | -5.31 | 100 | 29 | 4 | open_positions;loss |
